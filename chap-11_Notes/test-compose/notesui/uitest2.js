...
describe("Notes", function () {
  ...
  before(async function () {
    ...
    page.on("frameattached", async (frame) =>
      frameEvent("frameattached", await frame)
    );
    page.on("framedetached", async (frame) =>
      frameEvent("framedetached", await frame)
    );
    page.on("framenavigated", async (frame) =>
      frameEvent("framenavigated", await frame)
    );
      ...
      while (true) {
        ...
        try {
          href = await page.$eval(
            "#notesHomePage .btn-group-vertical .btn:first-child",
            (el) => el.href
          );
        } catch (e) {
  ...
  describe("Delete Note", function () {
    ...
    it("should return to home page", async function () {
      ...
      try {
        ...
        console.log(
          `deletenote after delete waiting for home page error ${errr.stack}`
        );
        throw errr;
      }
      await page.screenshot({
